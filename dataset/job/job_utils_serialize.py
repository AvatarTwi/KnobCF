...
from dataset.job.attr_rel_dict import *
import pickle
...
with open('dataset/job/attr_val_dict.pickle', 'rb') as f:
...
class JOBSerilalDataSet():
    def __init__(self, args,c_pool):
        ...
        path = os.path.join(self.args.local_datadir + 'job4base' + '/',
                            'serverlog0.txt')
