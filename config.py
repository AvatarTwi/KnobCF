...
class Configuration:
    ...
    def update_from_file(self,workload,specific,iters, filename):
        ...
        self.dict['benchmark_info']['workload'] = workload
        self.dict['benchmark_info']['specific'] = specific
        self.dict['global']['iters'] = iters
        self._postprocess()
    ...
    def _postprocess(self):
        ...
        assert benchmark_name in ['ycsb','ycsb_b','ycsb_c', 'oltpbench', 'benchbase']
