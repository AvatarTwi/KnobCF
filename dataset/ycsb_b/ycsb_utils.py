...
from dataset.ycsb.attr_rel_dict import *
...
ycsb_dim_dict = {'Seq Scan': num_rel + max_num_attr * 3 + basics,
...
with open('dataset/ycsb/attr_val_dict.pickle', 'rb') as f:
...
YCSB_GET_INPUT = collections.defaultdict(lambda: get_basics, YCSB_GET_INPUT)
...
class TPCHDataSet:
    def __init__(self, args):
        ...
        """
        self.args = args
        self.input_func = YCSB_GET_INPUT
