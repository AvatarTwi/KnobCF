...
from featurization.zero_shot_featurization.utils.fc_out_model import FcOutModel, Prediction
...
class ZeroShotModel(FcOutModel):
    ...
    def __init__(self, device='cuda:0', hidden_dim=None, input_dim=None, final_mlp_kwargs=None, output_dim=1,
                 ...
                 node_type_kwargs=None, feature_statistics=None,
                 add_tree_model_types=None, result=None, prepasses=None, plan_featurization=None,
    ...
    def update(self, feature_statistics, result):
